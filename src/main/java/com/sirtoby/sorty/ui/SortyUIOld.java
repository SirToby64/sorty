 ...
 * @author kockt
 */
public class SortyUIOld extends javax.swing.JFrame {
    ...
    private void rotateImage(RotationDirection rotationDirection) {
        ...
        final BufferedImage rotatedImage = rotateImage(sorty.getCurrentImage(), (double) rotation);
        scaleImage(rotatedImage);
    ...
    public static BufferedImage rotateImage(BufferedImage img, double rotation) {
        ...
        final BufferedImage newImage = new BufferedImage(width, height, img.getType());
        
        final Graphics2D g2 = newImage.createGraphics(); // it seems the image IN the BufferedImage is rotated, not the BufferedImage itself
    ...
    private void scaleImage(BufferedImage image) {
        ...
        System.out.println("jLabelContentImage.getWidth() = " + jLabelContentImage.getWidth());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SortyUIOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SortyUIOld().setVisible(true);
            }
        });
    }
